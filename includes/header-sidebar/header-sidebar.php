<div id="header">
    ...
    <span id="profile-logout"><img src="../../../assets/icons/user-solid.svg" alt="Profile" id="profile"><a href="http://localhost/minor_project/login/logout.php" id="logout">Logout</a></span>
</div>
<div id="body">
    <div id="side-bar">
        <div class="side-bar">
